...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_add_dot.setStyleSheet(
        ...
        self.button_del_dot.setStyleSheet(
            'background-color: rgb(255, 255, 255);')
        ...
        self.button_author.setContextMenuPolicy(
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_add_dot.setText(
            _translate('MainWindow', 'Поставить точку'))
        self.label_list.setText(_translate('MainWindow', 'Список точек'))
        self.button_clear.setText(_translate('MainWindow', 'Очистить поле'))
        self.label_input_coord.setText(_translate(
            'MainWindow', 'Введите координаты точки:'))
        ...
        self.label_num.setText(_translate(
            'MainWindow', 'Номер удаляемой точки:'))
